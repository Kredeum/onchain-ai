<script lang="ts">
  ...
  $inspect("<ReadOnlyFunctionForm", data, isFetching, transformedFunction);
  $inspect("<ReadOnlyFunctionForm", contractAddress, abiFunction.name);
  $inspect("<ReadOnlyFunctionForm", args);
</script>
